...
public class Busqueda {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("Dime la profundidad máxima a aplicar, por favor:");
            ...
            if ((opcion == 1) || (opcion == 2) || (opcion == 3) || (opcion == 4) || (opcion == 5) || (opcion == 6) || (opcion == 7)) {
                switch (opcion) {
                    case 1:
                        ...
                        resultado = Busqueda_Acotada(Prob, Estrategia.Anchura, profmax);
                        t = ((System.currentTimeMillis() - ini) / 1000f);
                        break;
                    case 2:
                        ini = System.currentTimeMillis();
                        System.out.println("Aplicando algoritmo de búsqueda...");
                        resultado = Busqueda_Acotada(Prob, Estrategia.Profundidad_Simple, profmax);
                        t = ((System.currentTimeMillis() - ini) / 1000f);
                        break;
                    case 3:
                        ini = System.currentTimeMillis();
                        System.out.println("Aplicando algoritmo de búsqueda...");
                        resultado = Busqueda_Acotada(Prob, Estrategia.Profundidad_Iterativa, profmax);
                        t = ((System.currentTimeMillis() - ini) / 1000f);
                        break;
                    case 4:
                        ini = System.currentTimeMillis();
                        System.out.println("Aplicando algoritmo de búsqueda...");
                        resultado = Busqueda_Acotada(Prob, Estrategia.Profundidad_Acotada, profmax);
                        t = ((System.currentTimeMillis() - ini) / 1000f);
                        break;
                    case 5:
                        ini = System.currentTimeMillis();
                        System.out.println("Aplicando algoritmo de búsqueda...");
                        resultado = Busqueda_Acotada(Prob, Estrategia.Coste_Uniforme, profmax);
                        t = ((System.currentTimeMillis() - ini) / 1000f);
                        break;
                    case 6:
                        ini = System.currentTimeMillis();
                        System.out.println("Aplicando algoritmo de búsqueda...");
                        resultado = Busqueda_Acotada(Prob, Estrategia.Voraz, profmax);
                        t = ((System.currentTimeMillis() - ini) / 1000f);
                        break;
                    case 7:
                        ini = System.currentTimeMillis();
                        System.out.println("Aplicando algoritmo de búsqueda...");
                        resultado = Busqueda_Acotada(Prob, Estrategia.Aasterisco, profmax);
                        t = ((System.currentTimeMillis() - ini) / 1000f);
                        break;
