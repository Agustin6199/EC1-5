...
public class Problema {
	...
	public void setEstadoInicial(Estado estadoInicial) {
        ...
        //Nos podríamos ahorrar estos métodos haciendo estadoInicial.getC().isSolved()
        //O bien si quieres un método que reciba un estado y compruebe si es solución 
        //se puede hacer poniendo como parámetro Estado e y haciendo la misma llamada e.getC().isSolved()
